...
import { NextArrow, PrveArrow } from "./ArrowComponent"

const HeroCarousalCompo = () => {
  ...
  return (
    <>
      ...
      {/* The below is for the large screen */}
...
export default HeroCarousalCompo
